			...
			<div className='flex flex-row items-center gap-8'>
				<div className='flex flex-col items-center'>
					...
					<div className='flex justify-center gap-4'>
						...
						<a
							href='https://www.linkedin.com/in/matiasatzori/'
							className='text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-300 dark:hover:text-white'
							target='_blank'
							rel='noopener noreferrer'
						>
				...
				<div className='flex flex-col items-center'>
					<p className='mb-2 text-sm text-gray-600 dark:text-gray-400'>Support me</p>
					<a
						href='https://www.buymeacoffee.com/kingmacking'
						target='_blank'
						rel='noopener noreferrer'
